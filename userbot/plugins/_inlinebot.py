    ...
    if event.query.user_id == bot.uid and query.startswith("UserBot"):
        ...
        result = builder.article(
            ...
            buttons=[
                ...
                [Button.url("Repo 🇮🇳", "https://github.com/Akcrazytech/Ak-Crazy-Tech-Userbot")],
                [Button.url("Join Channel ❤️", "t.me/")],
            ],
        )
        await event.answer([result])
...
async def sed(event):
    ...
    buttons = paginate_help(0, CMD_HELP, "helpme")
    sed = f"""Userbot Modules Are Listed Here !\n
For More Help or Support Visit \nCurrently Loaded Plugins: {len(CMD_LIST)}"""
...
async def inline_id_handler(event: events.InlineQuery.Event):
    ...
    if event.query.user_id != bot.uid:
        resultm = builder.article(
            title="Not Allowded",
            text=f"You Can't Use This Bot. \nDeploy Friday To Get Your Own UserBot, Repo Link [Here](https://github.com/Akcrazytech/Ak-Crazy-Tech-Userbot)",
        )
